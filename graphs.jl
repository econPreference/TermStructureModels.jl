...
plot(df, x="quantile(maximum SR, 0.95)", y="log marginal likelihood", color=:lag, Geom.point, Guide.yticks(ticks=28500:750:31500), Guide.xticks(ticks=[collect(0:5:20); collect(20:10:70)]), Theme(major_label_font_size=12pt, minor_label_font_size=10pt, key_label_font_size=10pt, point_size=3pt, key_title_font_size=12pt), Scale.color_continuous(minvalue=0, maxvalue=12)) |> PDF("/Users/preference/Library/CloudStorage/Dropbox/Working Paper/Prior for TS/slide/pf.pdf")

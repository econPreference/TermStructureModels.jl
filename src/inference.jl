...
"""
function tuning_hyperparameter(yields, macros, ρ, upper=[12, 1, 100, 2]; medium_τ=12 * [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5], maxtime=0.0, mSR_λ=1)
    ...
    function negative_log_marginal(input, p_max_)
        ...
        return -log_marginal(PCs[(p_max_-p)+1:end, :], macros[(p_max_-p)+1:end, :], ρ, tuned; medium_τ) + mSR_λ * upper_mSR

...
# tuned, EA_opt = tuning_hyperparameter_mSR(Array(yields[:, 2:end]), Array(macros[:, 2:end]), τₙ, ρ; maxstep=50_000, weight=1E+6, mSR_mean=0.75, upper_lag=8, upper_q1=0.1, upper_q45=50, σ²kQ_infty=0.01^2)

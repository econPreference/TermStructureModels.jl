...
tuned = tuning_hyperparameter(Array(yields[:, 2:end]), Array(macros[:, 2:end]), τₙ, ρ; mSR_tail=2.0, mSR_median=0.75, upper_lag=6, upper_q1=0.005, upper_q45=0.01, σ²kQ_infty=0.01^2)

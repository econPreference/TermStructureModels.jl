...
results.file <- getResultsFileName("sim_rrp_rjmcmc", N)
...
save(file=results.file, true.pars, priors, W, B, M, N, T, n, n.per, mats, Omega.i, lamQ.i, kinfQ.i, lambda.i, gamma.i, sige2.i)

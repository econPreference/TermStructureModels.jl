...
results.file <- getResultsFileName("sim_rrp_mcmc", N)
...
save(file=results.file, true.pars, priors, Ysim, W, B, M, N, T, n, n.per, mats, Omega.i, lamQ.i, kinfQ.i, lambda.i, sige2.i)
